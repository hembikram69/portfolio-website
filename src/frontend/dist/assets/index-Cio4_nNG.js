...
const highlights = [
  {
    ...
    description: "Expertise in full-stack development using .NET, C#, Python, JavaScript, AngularJS, and Bootstrap to build scalable, high-performance applications."
  },
  {
    id: "problem-solver",
    icon: Lightbulb,
    title: "Problem Solver",
    description: "Data-driven analytical approach to debugging, optimizing code, and designing efficient database schemas that improve performance."
  },
  {
    id: "team-player",
    icon: Users,
    title: "Team Player",
    description: "Strong communication and collaboration skills, working closely with clients, team members, and stakeholders across the full project lifecycle."
  }
];
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-24 lg:py-32 section-alt", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 lg:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-primary uppercase tracking-wider mb-3", children: "About Me" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading", children: [
        "Crafting Code,",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Driving Insights" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-base sm:text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "I'm a dedicated software developer with a dual background in software engineering and data processing. Currently pursuing an",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground font-semibold", children: "MSc in Data Analytics" }),
          " ",
          "at London Metropolitan University (Islington College), I blend technical expertise with analytical thinking to create innovative solutions."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "My passion lies in leveraging data insights to support robust, user-friendly application development. With hands-on experience building scalable systems like Hospital Management and LAB Software, I deliver",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground font-semibold", children: "client-focused solutions" }),
          " ",
          "that make a real impact."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6 pt-6", children: highlights.map((highlight, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          className: "card-hover border border-border/60 bg-card shadow-subtle group",
          style: { animationDelay: `${index2 * 0.1}s` },
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-6 text-center pb-7", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-primary/10 mb-5 group-hover:bg-primary/15 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(highlight.icon, { className: "w-6 h-6 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-semibold text-foreground mb-2", children: highlight.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: highlight.description })
          ] })
        },
        highlight.id
      )) })
...
const achievements = [
  {
    ...
    description: "Enhanced expertise in front-end development using HTML, CSS, JavaScript, AngularJS, and Bootstrap to deliver responsive and user-friendly interfaces.",
  ...
  },
  {
    ...
    description: "Gained extensive experience in debugging and optimizing code to improve application performance and scalability across enterprise-level systems.",
  ...
  },
  {
    ...
    description: "Enhanced communication and collaboration skills by leading developer teams and working with stakeholders throughout the full project lifecycle.",
    metric: "Led dev team"
  },
  {
    id: "client-handling",
    ...
    description: "Improved client satisfaction skills by providing regular updates, addressing feedback promptly, and delivering smooth post-deployment support.",
    metric: "Client delivered"
  }
];
function Achievements() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "achievements", className: "py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 lg:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-primary uppercase tracking-wider mb-3", children: "Impact" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading", children: [
        "Key ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-6", children: achievements.map((achievement) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        className: "card-hover border border-border/60 bg-card shadow-subtle group",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-6 pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/15 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(achievement.icon, { className: "w-5 h-5 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-semibold text-foreground leading-snug", children: achievement.title }),
              achievement.metric && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-primary font-medium bg-primary/8 px-2 py-0.5 rounded-full shrink-0", children: achievement.metric })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mt-2", children: achievement.description })
          ] })
        ] }) })
      },
      achievement.id
...
function Contact() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 lg:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-primary uppercase tracking-wider mb-3", children: "Contact" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading", children: [
        "Let's ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Connect" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-4 max-w-lg mx-auto text-base leading-relaxed", children: "Open to new opportunities, collaborations, and conversations about technology. Reach out through any channel below." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-2xl overflow-hidden mb-10 p-8 text-center shadow-premium", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-hero" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 dot-grid opacity-15" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-14 h-14 rounded-2xl glass-dark mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-6 h-6 text-white" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white mb-2", children: "Ready to build something great?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/65 text-sm mb-5 max-w-sm mx-auto", children: "Whether it's a new project or just a tech chat — I'd love to hear from you." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "mailto:bhembikram@gmail.com", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-5", children: contactMethods.map((method) => {
        ...
        Card,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-6 pb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/15 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5 text-primary" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: method.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/70 mt-0.5", children: method.description })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4", children: method.href ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "outline",
                size: "sm",
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  ...
                  {
                    href: method.href,
                    target: method.href.startsWith("http") ? "_blank" : void 0,
                    rel: method.href.startsWith("http") ? "noopener noreferrer" : void 0,
                    children: [
                      method.value,
                      method.href.startsWith("http") && /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "ml-2 h-3.5 w-3.5" })
                    ]
                  }
                )
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground px-1", children: method.value }) })
          ] })
        },
        method.id
      );
...
const education = [
  {
    ...
    description: "Pursuing advanced studies in data analytics, focusing on data processing, statistical analysis, and leveraging insights for data-driven decision-making.",
    achievements: [
  ...
  },
  {
    ...
    period: "2022 – 2025",
    location: "Kathmandu, Nepal",
    description: "Comprehensive study of software engineering, algorithms, data structures, and modern web technologies with hands-on project experience.",
    achievements: [
...
function Education() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "education", className: "py-24 lg:py-32 section-alt", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 lg:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-primary uppercase tracking-wider mb-3", children: "Academic" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading", children: [
        "Education &",
        " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: education.map((edu, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden sm:flex flex-col items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `w-12 h-12 rounded-xl flex items-center justify-center z-10 shadow-elevated ${index2 === 0 ? "bg-primary" : "bg-primary/10"}`,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              GraduationCap,
              {
                className: `w-5 h-5 ${index2 === 0 ? "text-primary-foreground" : "text-primary"}`
              }
            )
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "flex-1 card-hover border border-border/60 bg-card shadow-subtle", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "pb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-lg font-bold leading-tight", children: edu.degree }),
              index2 === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-primary bg-primary/10 px-2.5 py-1 rounded-full shrink-0", children: "Current" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-primary text-sm", children: edu.institution }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3 text-xs text-muted-foreground mt-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed mb-4", children: edu.description }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-semibold text-foreground uppercase tracking-wide mb-2", children: "Highlights" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1.5", children: edu.achievements.map((achievement) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
...
function Experience() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "experience", className: "py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 lg:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-primary uppercase tracking-wider mb-3", children: "Career" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading", children: [
        "Work ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: experiences.map((exp) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        className: "card-hover border border-border/60 bg-card shadow-subtle overflow-hidden",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-1 bg-gradient-primary" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "w-5 h-5 text-primary" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-xl font-bold", children: exp.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs shrink-0", children: exp.type })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3 mt-1.5 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-primary", children: exp.company }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2.5 mb-5", children: exp.responsibilities.map((responsibility) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: responsibility })
                ]
              },
              responsibility
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 pt-3 border-t border-border/40", children: exp.technologies.map((tech) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                variant: "secondary",
...
function Footer() {
  ...
  const appIdentifier = typeof window !== "undefined" ? encodeURIComponent(window.location.hostname) : "portfolio-app";
  const scrollToSection = (href) => {
    var _a2;
    (_a2 = document.querySelector(href)) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth", block: "start" });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-10 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold font-display text-gradient", children: "HB" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground mt-1", children: "Hembikram Bist" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Software Developer & Data Analyst" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3 h-3" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Kathmandu, Nepal" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: socialLinks$1.map(({ href, icon: Icon2, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-foreground uppercase tracking-wider", children: "Quick Links" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: navLinks.map(({ label, href }) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-foreground uppercase tracking-wider", children: "Get In Touch" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-5 border-t border-border/40 flex flex-col sm:flex-row items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground text-center sm:text-left", children: [
        "© ",
        currentYear,
        " Hembikram Bist. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Built with" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-3.5 h-3.5 text-destructive fill-destructive" }),
...
function Hero() {
  const scrollToAbout = () => {
    var _a2;
    (_a2 = document.querySelector("#about")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth", block: "start" });
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-hero z-0" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-0 dot-grid opacity-20" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 z-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_-10%,oklch(0.55_0.22_250/0.35),transparent)]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 text-center lg:text-left space-y-7 animate-fade-in-up", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full glass-dark text-white/80 text-xs font-medium border border-white/10", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3.5 h-3.5" }),
                "Kathmandu, Nepal"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-5xl sm:text-6xl lg:text-7xl xl:text-display-xl font-bold font-display leading-none text-gradient-hero", children: [
                  "Hembikram",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                  "Bist"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 justify-center lg:justify-start", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-8 bg-white/30 rounded-full" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg sm:text-xl text-white/80 font-medium tracking-wide", children: "Software Developer & Data Analyst" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg text-white/65 max-w-xl mx-auto lg:mx-0 leading-relaxed", children: "Full-stack developer with expertise in .NET, C#, Python, and data analytics. Passionate about building scalable, user-centric applications and transforming data into actionable insights." }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3 justify-center lg:justify-start pt-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    size: "lg",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    ...
                    children: [
                      "Learn More",
                      /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowDown, { className: "ml-2 w-4 h-4" })
                    ]
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 justify-center lg:justify-start pt-1", children: [
                socialLinks.map(({ href, icon: Icon2, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    href,
                    target: "_blank",
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-4.5 h-4.5" })
                  },
                  label
                )),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    ...
                    children: "bhembikram@gmail.com"
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-6 justify-center lg:justify-start pt-4 border-t border-white/10", children: stats.map(({ value, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center lg:text-left", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-white font-display", children: value }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/55 mt-0.5", children: label })
              ] }, label)) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      style: {
                        background: "conic-gradient(from 0deg, oklch(0.66 0.22 250), oklch(0.70 0.18 280), oklch(0.60 0.20 200), oklch(0.66 0.22 250))"
                      },
                      "aria-hidden": "true"
                    }
                  ),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute -bottom-3 -right-3 glass-dark px-4 py-2 rounded-xl border border-white/15 shadow-elevated z-20", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-xs font-semibold", children: "MSc Data Analytics" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-xs", children: "London Metropolitan Univ." })
                  ] })
                ] })
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 text-white/40 animate-bounce-subtle", children: [
...
const interests = [
  {
    ...
    description: "Continuously learning and experimenting with emerging web technologies and frameworks to stay current with industry trends.",
    tag: "Learning"
  },
  {
    id: "open-source",
    ...
    description: "Actively contributing to open-source projects to give back to the developer community and collaborate with developers worldwide.",
    tag: "Community"
  },
  {
    ...
    description: "Engaging in coding competitions to sharpen problem-solving skills and discover new algorithms and techniques.",
    tag: "Competition"
  }
];
function Interests() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "interests", className: "py-24 lg:py-32 section-alt", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 lg:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-primary uppercase tracking-wider mb-3", children: "Passions" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading", children: [
        "Interests & ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Pursuits" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-5 lg:gap-6", children: interests.map((interest) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        className: "card-hover border border-border/60 bg-card shadow-subtle group text-center",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-8 pb-7", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-primary/10 mb-5 group-hover:bg-primary/15 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(interest.icon, { className: "w-6 h-6 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-xs font-semibold text-primary bg-primary/8 px-2.5 py-1 rounded-full mb-3", children: interest.tag }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-semibold text-foreground mb-3 leading-snug", children: interest.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: interest.description })
        ] })
      },
      interest.id
    )) })
...
function Navigation() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "nav",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-400 ${isScrolled ? "glass border-b border-border/50 shadow-subtle" : "bg-transparent"}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16 lg:h-20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "HB" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:flex items-center space-x-0.5 lg:space-x-1", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => scrollToSection(item.href),
            className: `nav-link px-3 py-1.5 rounded-md text-sm font-medium transition-smooth hover:bg-muted/50 ${activeSection === item.href.slice(1) ? "active text-primary" : "text-muted-foreground hover:text-foreground"}`,
            children: item.label
          },
          item.href
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open: isOpen, onOpenChange: setIsOpen, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTrigger, { asChild: true, className: "md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "ghost",
              size: "icon",
              "aria-label": "Toggle mobile menu",
              children: isOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "h-5 w-5" })
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SheetContent, { side: "right", className: "w-[280px] sm:w-[320px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col space-y-1 mt-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wider px-3 mb-4", children: "Navigation" }),
            navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => scrollToSection(item.href),
                className: `text-left text-base font-medium px-3 py-2.5 rounded-lg transition-smooth ${activeSection === item.href.slice(1) ? "text-primary bg-primary/8" : "text-foreground hover:text-primary hover:bg-muted/50"}`,
                children: item.label
              },
              item.href
            ))
...
const projects = [
  {
    ...
    description: "Comprehensive system to automate patient records, appointments, billing, and inventory management for healthcare facilities.",
    features: [
  ...
  },
  {
    ...
    description: "End-to-end laboratory management solution enabling efficient handling of lab tests, patient reports, and inventory for a client.",
    features: [
...
function Projects() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projects", className: "py-24 lg:py-32 section-alt", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 lg:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-primary uppercase tracking-wider mb-3", children: "Portfolio" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading", children: [
        "Featured ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Projects" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-4 max-w-xl mx-auto text-sm", children: "Real-world applications built end-to-end, from requirements gathering to client deployment." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-7", children: projects.map((project, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        className: "card-hover border border-border/60 bg-card shadow-subtle overflow-hidden",
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center ${index2 === 0 ? "bg-primary text-primary-foreground" : "bg-primary/10"}`,
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  FolderGit2,
                  {
                    className: `w-5 h-5 ${index2 === 0 ? "text-primary-foreground" : "text-primary"}`
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-xl font-bold", children: project.title }),
                project.badge && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "text-xs bg-primary/10 text-primary border-primary/20 font-medium shrink-0", children: project.badge })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-primary font-medium mt-0.5", children: project.subtitle }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1.5 leading-relaxed", children: project.description })
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-semibold text-foreground uppercase tracking-wide mb-3", children: "Key Features" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2", children: project.features.map((feature) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-3 border-t border-border/40", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-semibold text-foreground uppercase tracking-wide mb-2", children: "Tech Stack" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: project.technologies.map((tech) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: "secondary",
                  className: "text-xs px-2.5 py-0.5 hover:bg-primary hover:text-primary-foreground transition-smooth cursor-default",
...
function Skills() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "skills", className: "py-24 lg:py-32 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12 lg:mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-primary uppercase tracking-wider mb-3", children: "Capabilities" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-heading", children: [
        "Skills & ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "Expertise" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-4 max-w-xl mx-auto text-sm", children: "Technologies and methodologies I use to build robust, scalable software solutions." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5", children: skillCategories.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
        className: "card-hover border border-border/60 bg-card shadow-subtle group",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-lg bg-muted flex items-center justify-center group-hover:bg-primary/10 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              category.icon,
              {
                className: `w-4.5 h-4.5 ${category.color}`
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-sm font-semibold leading-tight", children: category.category })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: category.skills.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
              variant: "secondary",
